  ...
  return (
    <div>
      <div className="relative">
        ...
        ></img>
        <div className="flex  gap-[150px]  absolute top-[0px]  text-black">
          <div className="pt-[100px] pl-[80px]">
            <div className="flex gap-[5px] ">
              ...
              >
                ...
                ></path>
                <path
                  d="M108.743 47.184v-37.11h7.435v37.11h-7.435ZM121.983 47.184v-37.11h7.434v37.11h-7.434Z"
                  fill="#142800"
                ></path>
                <path
                  fill-rule="evenodd"
              ...
              <FaPlus className="text-[16px] mt-[7px] text-blue-700" />
            </div>

            <h1 className="text-[70px] pt-[20px] font-serif font-medium">
          ...
          <div className="overflow-x-auto w-[475px] mt-[60px] mx-[50px] rounded-2xl  bg-white p-[20px]">
            <table className="table rounded-lg">
              {/* head */}
              <thead>
                <tr>
                  <th className="text-black text-[14px]  ">Features</th>
                  <th className="text-black text-[14px]  pl-[50px]">Free</th>
              ...
              <tr className="bg-base-200">
                <td className="text-[16px]  font-bodyFont ">
                  Access 200+ Guides
                </td>
                <td className=" pl-[40px]">
                  <h1 className="bg-black   text-white rounded-[5px] pl-[9px] h-[23px]   w-[50px]  text-[16px]">
                    New
                  </h1>
                </td>
                <td>
              ...
              <tr className="bg-base-200   ">
                <td className=" text-[16px] font-bodyFont  w-full absolute  ">
              ...
              <tr>
                <td className="text-[16px] w-full absolute   font-bodyFont ">
              ...
              <tr className="">
                <td className="text-[16px]  font-bodyFont absolute w-full  ">
