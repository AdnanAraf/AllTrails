  ...
  return (
    <div className="bg-[#f6f5e8] h-[680px] w-[1250px] container mx-[130px] mt-[-100px] absolute rounded-[50px]">
      <div className="grid grid-rows-3 gap-[30px] absolute top-[300px] left-[20px] font-semibold">
        ...
        <button className="text-[18px]  underline" onClick={handleButton2Click}>
          Navigate & track
        </button>
        <button
        ...
        <div className="flex gap-[20px]">
          ...
          <div>
            ...
            <h4 className="text-[20px] font-semibold w-[400px] mt-[20px]">
              ...
              community of adventurers like you.
            </h4>
          </div>
        </div>
      )}
      ...
      {showButton2Info && (
        <div className="flex gap-[20px]">
          ...
          <div className="">
            ...
            <h4 className="text-[20px] font-semibold w-[400px] mt-[20px]">
              Out on the trail, you can keep an eye on your planned route, along
              with elevation changes and waypoints.
            </h4>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-3 mt-[100px] ">
        ...
        <div>
          ...
          <p className="text-center text-[14px]  text-[#2b381f] mt-[20px] font-semibold font-titleFont">
            Share your adventures and learn from our <br></br>global community.
          </p>
        </div>
        <div>
          <h1 className="text-[60px] text-[#2b381f] font-semibold text-center">
